module.exports = {
    verify_your_account : (username, support_email, link) => `<style>
    body,
    table,
    td,
    a {
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="480">
                    <tr>
                        <td bgcolor="#1f1f2b" align="left" valign="top"
                            ...
                            <h1 style="text-decoration: underline; font-size: 32px; font-weight: 400; margin: 0;">Verify Your Email Address</h1>
                        </td>
                    </tr>
                </table>
            </td>
                                ...
                                <tr>
                                    <td colspan="2"
                                        ...
                                        <p style="color: #f9f9f9;">Hi ${username.toString()},<br><br>
                                            ...
                                            You registered an account on <b>Pro Hack Academy</b>, before being able to use your account you need to confirm your email address.<br><br>
                                            Once again &#8211; thank you for joining our <b>Pro Hack Academy</b><br><br>
                                            ...
                                            <tr>
                                                <td align="left" style="border-radius: 3px;" bgcolor="#181821">
                                                    <a href="${link}" target="_blank" rel="noopener noreferrer"
                                                        style="font-size: 20px; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; color: #ffffff; text-decoration: none; padding: 11px 22px; border-radius: 2px; border: 1px solid #83d8ae; display: inline-block;">Verify</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="480">
                    <tr>
                        <td bgcolor="#181821" align="left"
                            ...
                            <p style="margin: 0;">Kind Regards, <a href="https://fix-assist.com" target="_blank" rel="noopener noreferrer"
                                    style="color: #f9f9f9; font-weight: 700;">Fix Assist Tech Solutions<a></p>
                        </td>
                    </tr>
            </td>
        </tr>
